...
const MiniCart = () => {
  ...
  return (
    ...
    >
      ...
      {/* MiniCart panel */}
      <div
        className={`h-full w-80 bg-white shadow-lg transform transition-transform duration-300 flex flex-col ${
          isCartOpen ? "translate-x-0" : "translate-x-full"
        }`}
      >
        {/* Header */}
        <div className="flex justify-between items-center p-4 pt-16 border-b flex-shrink-0">
          ...
          <div className="p-4 border-t flex flex-col gap-3 flex-shrink-0">
            ...
            <div className="flex gap-2">
              <Link
                to="/cart"
                onClick={closeCart}
                className="flex-1 bg-red-500 text-white py-2 rounded text-center"
              >
                View Cart
              </Link>
              <button
